...
# Save initial environment variables passed via CLI to prioritize them over config file values
INITIAL_COBIEN_DISPLAY_ROTATION="${COBIEN_DISPLAY_ROTATION:-}"
INITIAL_COBIEN_DISPLAY_OUTPUT="${COBIEN_DISPLAY_OUTPUT:-}"
INITIAL_COBIEN_DISPLAY_MODE="${COBIEN_DISPLAY_MODE:-}"
INITIAL_COBIEN_WORKSPACE_ROOT="${COBIEN_WORKSPACE_ROOT:-}"
...
load_selected_env_settings() {
    ...
    PROJECT_DIR="$(expand_path_value "${INITIAL_COBIEN_WORKSPACE_ROOT:-${COBIEN_WORKSPACE_ROOT:-$PROJECT_DIR}}")"
    ...
    DISPLAY_OUTPUT="${INITIAL_COBIEN_DISPLAY_OUTPUT:-${COBIEN_DISPLAY_OUTPUT:-$DISPLAY_OUTPUT}}"
    DISPLAY_MODE="${INITIAL_COBIEN_DISPLAY_MODE:-${COBIEN_DISPLAY_MODE:-$DISPLAY_MODE}}"
    DISPLAY_ROTATION="${INITIAL_COBIEN_DISPLAY_ROTATION:-${COBIEN_DISPLAY_ROTATION:-$DISPLAY_ROTATION}}"
